...
" vem-tabline
exec "highlight VemTablineNormal           term=reverse cterm=none ctermfg=". s:blue ." ctermbg=". s:black ." guifg=#242424 guibg=#cdcdcd gui=none"
exec "highlight VemTablineLocation         term=reverse cterm=none ctermfg=". s:blue ." ctermbg=". s:black ." guifg=#666666 guibg=#cdcdcd gui=none"
exec "highlight VemTablineNumber           term=reverse cterm=none ctermfg=". s:blue ." ctermbg=". s:black ." guifg=#666666 guibg=#cdcdcd gui=none"
exec "highlight VemTablineSelected         term=bold cterm=bold ctermfg=". s:black ." ctermbg=". s:green ." guifg=#242424 guibg=#ffffff gui=bold"
exec "highlight VemTablineLocationSelected term=bold cterm=none ctermfg=". s:black ." ctermbg=". s:green ." guifg=#666666 guibg=#ffffff gui=bold"
exec "highlight VemTablineNumberSelected   term=bold cterm=none ctermfg=". s:black ." ctermbg=". s:green ." guifg=#666666 guibg=#ffffff gui=bold"
exec "highlight VemTablineShown            term=reverse cterm=none ctermfg=". s:black ." ctermbg=". s:red ." guifg=#242424 guibg=#cdcdcd gui=none"
exec "highlight VemTablineLocationShown    term=reverse cterm=none ctermfg=". s:black ." ctermbg=". s:red ." guifg=#666666 guibg=#cdcdcd gui=none"
exec "highlight VemTablineNumberShown      term=reverse cterm=none ctermfg=". s:black ." ctermbg=". s:red ." guifg=#666666 guibg=#cdcdcd gui=none"
